...
class SearchPage extends SearchDelegate<Etudiant> {
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    List<Etudiant> suggestionList = query.isEmpty
        ? recentEtudiant
        : listEtudiant.where((p) => p.nomComplet.startsWith(query)).toList();
    String textInfo = query.isEmpty
        ? 'Recherche récente'
        : 'Resultat( ${suggestionList.length} )';
        ...
        Container(
          ...
          child: suggestionList.isEmpty && query.isNotEmpty?Center(
            ...
            itemBuilder: (context, index) => ListTile(
              ...
              subtitle: Text('Id Élève : ${suggestionList[index].idDonne}'),
              title: RichText(
